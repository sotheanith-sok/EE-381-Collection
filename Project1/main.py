...
"""
def printRandomNumberGenerator(s,z):
    print('Part 2: Random Number Generator')
    l=randomNumberGenerator(s,z)
    print('List of random generated values:', ', '.join(str(s) for s in l))
    
def randomNumberGenerator(s,z):
    l=[]
    N=10000
    A=4857
    M=8601
...
"""
def probabilityCalculation(s):
    slot=[0]*5
    counter=0
    total=0
    rand=(randomNumberGenerator(int(time.time()),s*3))
